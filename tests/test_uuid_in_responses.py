...
# NOTE: TestNestedEntityUUIDs class removed since nested entity creation
# (library.documents, document.chunks) is no longer supported.
# Documents and chunks must now be created via separate API calls.
